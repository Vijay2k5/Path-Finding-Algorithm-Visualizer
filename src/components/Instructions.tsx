  ...
  return (
    <div className="bg-blue-50 rounded-lg p-4 mb-6 max-w-6xl w-full">
      ...
      <ul className="list-disc list-inside space-y-1 text-sm text-gray-700">
        ...
        <li><strong>BFS</strong> and <strong>DFS</strong> are unweighted search algorithms (does not account for weights)</li>
        <li><strong>Dijkstra's</strong> and <strong>A*</strong> are weighted search algorithms (accounts for weights)</li>
      </ul>
    </div>
  );
}
